...
const stripe = require('stripe')('sk_test_51PVI2vLFklFNM5KgtUnpaPKe2fnwN8GvPRO7WbXMo8pQMMnbSbIQ4dl7cs3fY5S3poTy4F697lRcFEtYUhWBQiLH002KB8TtaS');
...
app.post('/checkout-session', async (req, res) => {
  try {
    ...
    const query = 'INSERT INTO compras (productos, total, fecha_hora) VALUES (?, ?, NOW())';
